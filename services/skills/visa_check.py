...
Unknown passports are honest (no invented rules). The frozen visa_guard is
...
class VisaCheckSkill(SkillBase):
    ...
    def _freshness(self, citations: List[Dict[str, Any]]) -> str:
        ...
        for cit in citations:
            ...
            try:
                stamp = datetime.fromisoformat(str(raw)[:10]).date()
    ...
    async def run(self, payload: Dict[str, Any],
        ...
        return {
            ...
            "baseline_only": False,
            "degraded": False,
            "freshness_state": self._freshness(citations),
        }
