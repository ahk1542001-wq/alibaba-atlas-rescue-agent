...
def test_skill_manifests_are_documented_and_registry_stays_at_11():
    # frozen tests pin the loader-glob registry at exactly 11 manifests;
    # the safety manifests are documented OUTSIDE services/skills/
